...
void main() {
  group('MdictReader Tests', () {
    test('MdictReader initialization with mock header', () async {
      ...
      const headerContent = '<root Encoding="UTF-8" GeneratedByEngineVersion="2.0" Encrypted="No"/>\u0000\u0000';
      final headerBytes = Uint8List.fromList(headerContent.codeUnits);
      final sizeBytes = ByteData(4)..setUint32(0, headerBytes.length, Endian.big);
      
      final mockData = Uint8List.fromList([...sizeBytes.buffer.asUint8List(), ...headerBytes]);
